...
export default function PrabhupadQuotes() {
  ...
  return (
    <section className="w-full py-24 md:py-32 bg-linear-to-b from-[#0a2540] to-[#041120] font-sans relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#ff6b4a]/5 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#00a8cc]/10 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="w-full md:w-7/12 flex flex-col items-center md:items-start space-y-8 text-center md:text-left">
            <div className="w-full relative min-h-[150px] flex items-center">
